...
- **未確認 (ユーザーが後で確認)**: 前払式通信販売の承諾通知 (特商法 13 条)。代金を先に受け取って商品をすぐ送らないので、注文確認メールが承諾通知の記載事項 (承諾の旨・受領金額と年月日・販売業者の名称・住所・電話番号・商品名と数量・引渡時期) を満たす必要がある。Shopify 既定の注文確認メールには住所・電話番号・引渡時期が無い。満たすなら「通知メール」の要領で 1 ブロック足す
