...
- 確認済み: 管理画面のプレビュー (見本注文) でインボイス欄・承諾欄とも Liquid エラーなく描画される。**未確認**: 実注文で 8% 側に振り分けられること、承諾欄のお届け時期に配送方法名の括弧内が出ること (テスト注文が必要)
