...
| プラン | ハンドル | 商品 ID | 税込価格 (税抜) | SKU |
|---|---|---|---|---|
| 初回販売 (〜11/30。新之助 5kg ＋ きたりえカレー 2 個) | `shinnosuke-5kg-kitarie-curry-set` | 7982710358067 | 6,264 円 (5,800 円) | NJ-SHIN-5KG-CURRY |
| レギュラー (12/1〜。5kg) | `shinnosuke-5kg` | 7982710554675 | 5,724 円 (5,300 円) | NJ-SHIN-5KG |

- ストアは税込表示 (`shop.taxesIncluded = true`) なので、**商品には税抜 × 1.08 の税込価格を入れる**。2026-09-24 は計画の税抜 6,000 円 × 1.08 = 6,480 円で登録。2026-09-26 にユーザーが管理画面で 5,800 円 / 5,300 円 (税抜のつもり) に変えていたので、同日 ×1.08 の税込額 (6,264 円 / 5,724 円) に登録し直した (`productVariantsBulkUpdate`)
