...
- **キャンセル (2026-09-26 決定)**: **「ご注文確定後のキャンセルはお受けできません」の 1 文だけ** (特商法・返金ポリシー同文)。Claude が提案した「予約販売は出荷準備前までフォーム連絡で可」の例外と、複数回配送の途中解約・返金不可の文は、同日夜にユーザーが管理画面で削除して元に戻した。**キャンセルの例外・緩和は再提案しない**
