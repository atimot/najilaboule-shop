...
- ロゴ (2026-09-24): **9 色の丸アイコン＋「Naji la boule / ナジラブール」の 2 行** を横並びにした PNG (`najilaboule-logo.png`、1068×185)。文字は墨 #1f1f1f・背景透明、アイコンは元の地色 #231816 のまま。高さは PC 48px / スマホ 28px (スマホのロゴ欄は 375px 幅で約 167px しかなく、36px にすると幅約 208px ではみ出すため)。反転ロゴは未設定 (透明ヘッダーを使っていないので不要)
